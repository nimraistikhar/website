    ...
    <IndexLayout canonical="/privacy/" title="Privacy">
            <TextBox>
                ...
                <p>
				    ...
				    the data <a href="#short">in short</a> and <a href="#detailed">in a more detailed form</a>.
                </p>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul>
                                ...
                                <li>to analyze your use of our Service and improve our Service with our legitimate interests of marketing and fraud
								prevention,</li>
                            ...
                            <p>Applicable legal provisions are in particular those of the regulation (EU) 2016/679 of the European Parliament and
							...
							providing such data you may face legal disadvantages, for example, limited or no possibility of using our Service.</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
							...
							processing is based in your consent.</p>
                            <p> You are entitled to access the data stored by us and are also entitled to amend or rectify your data if such data are
							incorrect.</p>
                            <p> You have the right to object to the processing of your personal data, for example if your personal data are processed
							for direct marketing purposes.</p>
                            <p>You are entitled to request the erasure of your data. </p>
                            <p>You are entitled to receive information about the stored data (in a structured, current and machine-readable format)
							at any time and to request the correction or deletion of the data in case of incorrect data storage.</p>
                            <p>You have also the right to lodge a complaint with a supervisory authority at your choice. An overview of the European
							National Data Protection Authorities may be found here: http://ec.europa.eu/newsroom/article29/item-detail.cfm?item_id=612080<br
                                />
                            </p>
                        </td>
                    </tr>
                ...
                <ul>
                    ...
                    <li><a href="#details-II">II. How are my Data processed when visiting the Website and contacting us?</a></li>
                    <li><a href="#details-III">III. What Third Party Services, Cookies, Analytics and Social Plugins does the Website use?</a></li>
                    <li><a href="#details-IV">IV: How are my data processed when using the Gitpod Service (with User Account)?</a></li>
                    <li><a href="#details-V">V: How are Data processed when visiting our Social Media pages?</a></li>
                    <li><a href="#details-VI">VI. Are my Data transferred to Third Parties? Does automated decision making including profiling take place?</a></li>
                    <li><a href="#details-VII">VII. Are my Data transferred outside the EU?</a></li>
                    <li><a href="#details-VIII">VIII. Your Rights</a></li>
                    <li><a href="#details-IX">IX. Duration of Storing your Data; Data Security; Access and Changes to this Privacy Policy; Contact Details</a></li>
                </ul>
                ...
                <p id="mailchimp">
                    ...
                    The mail provider <strong>"Mailchimp"</strong> by Rocket Science Group LLC, 675 Ponce De Leon Ave NE, Suite 5000, Atlanta,
                ...
                <p>
                    <strong>You can withdraw your consent or object to the processing of data (email address) and their respective use for
					sending the newsletter and analyzing your data at any time.</strong> This can be done free of charge (except for the
        transmission costs) and via a link in the newsletter itself or notification to us or, if applicable, to Mailchimp.
                ...
                <h3>Cookies</h3>
                <p>
                    In order to offer you a convenient online service featuring numerous functions, our Website uses text files (<strong>"Cookies"</strong>)
                ...
                <p>
                    <strong>OPT-OUT:</strong> You can deactivate the use of Cookies in the settings of your browser at any time. To find
            ...
            and Google LLC, Mountain View, CA, USA (<strong>"Google"</strong>).
                ...
                <p>
                    We point out that an <a href="#details-VI">automated decision making or profiling</a> can take place when integrating
                    Google or an existing Google account.
			        </p>
                <p>For Users who have their usual residence in the European Economic Area or Switzerland,
      ...
      applicable data protection laws.</p>
                <p>
                    You can also find more information in Google's privacy policy <a href="https://policies.google.com/privacy">https://policies.google.com/privacy</a>.
			        </p>

                <h3>Google Fonts</h3>
                <p>
                    Our Website uses the <strong>"Google Fonts"</strong> service of Google (inter alia Google Ireland Limited,
            ...
            above [add link to opt-out in the “Cookies” section above].
				...
				operated by GitHub Inc., 88 Colin P Kelly Jr St, San Francisco, CA 94107, USA, (<strong>"Existing Account"</strong>).
			        </p>
            ...
            basis: Art. 6 (1) c. GDPR), for example legal retention periods.
				...
				for example <a href="#freshchat">FreshChat</a>. For details please refer to <a href="#details-III">III.</a> above
				as well as <a href="#details-VI">VI.</a> and <a href="#details-VII">VII.</a> below.
			        </p>
...
</p><h2 id="details-V">V. How are Data processed when visiting our Social Media pages?</h2>
                <p>
                    We operate pages on
</p>
                <ul>
                    <li>Twitter (twitter.com or applications) by Twitter Inc., 1355 Market Street, Suite 900,
                    San Francisco, CA 94103, USA, please also refer to: https://twitter.com/de/privacy /
https://twitter.com/personalization;</li>
                    <li>Medium (medium.com or applications) by A Medium Corporation, 799 Market Street,
                    5th Floor, San Francisco, CA 94103, USA, please also refer to:
                    https://medium.com/policy/medium-privacy-policy-f03bf92035c /
https://medium.com/me/settings / https://medium.com/me/following/suggestions</li>
                    <li>Spectrum Chat (spectrum.chat or applications) by GitHub Inc., 88 Colin P Kelly Jr St,
                    San Francisco, CA 94107, USA, please also refer to:
https://spectrum.chat/privacy.html</li>
                </ul>
                <p>
				...
				by <a href="#google">Google/Youtube</a>, <a href="#mailchimp">Mailchimp</a>, <a href="#github">GitHub</a>, <a href="#chargebee">Chargebee</a> and , <a href="#stripe">Stripe</a> are affected.
			</p>
...
further information please refer to <a href="#details-V">section V.</a>.
</p>
				...
				legal retention periods, e.g. in accordance with the German Commercial Code <em>(Handelsgesetzbuch, HGB)</em> and
				the Tax Code <em>(Abgabenordnung, AO)</em>.
			</p>
